...
| ~~**B14**~~ | ~~Derive and propose the BPM from the aligned onsets~~ — **DROPPED 2026-08-14.** See "Why B14 was dropped" below. The tempo is supplied by the performer, where it is exact. | — |
